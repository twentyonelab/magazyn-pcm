...
const DEMO: ReadonlyArray<Omit<Lokalizacja, 'stan' | 'opis' | 'id'>> = [
  { miasto: 'Katowice', lon: 19.0232, lat: 50.2585 },
  { miasto: 'Zabrze', lon: 18.7854, lat: 50.3084 },
  { miasto: 'Bytom', lon: 18.922, lat: 50.3469 },
  { miasto: 'Sosnowiec', lon: 19.1302, lat: 50.2761 },
  { miasto: 'Rybnik', lon: 18.5424, lat: 50.0959 },
  { miasto: 'Tychy', lon: 18.9865, lat: 50.1131 },
  { miasto: 'Chorzów', lon: 18.9536, lat: 50.2974 },
  { miasto: 'Dąbrowa Górnicza', lon: 19.2081, lat: 50.3309 },
  { miasto: 'Jastrzębie-Zdrój', lon: 18.5971, lat: 49.9502 },
  { miasto: 'Ruda Śląska', lon: 18.8745, lat: 50.2859 },
  { miasto: 'Częstochowa', lon: 19.1182, lat: 50.8119 },
  { miasto: 'Bielsko-Biała', lon: 19.0468, lat: 49.8232 },
  { miasto: 'Tarnowskie Góry', lon: 18.8548, lat: 50.4444 },
  { miasto: 'Racibórz', lon: 18.2182, lat: 50.0917 },
  { miasto: 'Cieszyn', lon: 18.6337, lat: 49.7486 },
  { miasto: 'Żywiec', lon: 19.2012, lat: 49.6886 },
  { miasto: 'Mysłowice', lon: 19.1386, lat: 50.2423 },
  { miasto: 'Siemianowice Śląskie', lon: 19.032, lat: 50.3024 },
  { miasto: 'Piekary Śląskie', lon: 18.9449, lat: 50.3844 },
  { miasto: 'Wodzisław Śląski', lon: 18.4658, lat: 50.0026 },
];
...
export const LOKALIZACJE: ReadonlyArray<Lokalizacja> = [
  ...
  ...DEMO.map((d) => ({
    ...
    miasto: d.miasto,
    opis: 'Punkt demonstracyjny — bez instalacji i bez danych',
    lon: d.lon,
    lat: d.lat,
    stan: 'demo' as const,
  })),
